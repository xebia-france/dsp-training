...
NEW_PREDICTIONS = os.path.join(OUTPUT_DATA, f"{m.LOGISTIC_REG_MODEL_NAME}_new_predictions.csv")
PREDICTIONS_HISTORY = os.path.join(OUTPUT_DATA, f"{m.LOGISTIC_REG_MODEL_NAME}_predictions_history.csv")
